...
urlpatterns = [
    ...
    path('orders/<str:order_id>/return/request/', views.request_return, name='request_return'),
    path('orders/download-invoice/<str:order_id>/', views.download_invoice, name='download_invoice'),
